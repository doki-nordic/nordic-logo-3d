...
function invPerspective(p, z, z0) {
    return {
        x: p.x * z / z0,
        y: p.y * z / z0,
        z,
...
function pointFromPlaneAnd2D(P, N, D, z0) {
    return {
...
function pointFromPlanes(N1, D1, N2, D2, N3, D3) {
    return {
...
function pointFromPlaneAndLine(P1, P2, P3, A, B) {
...
function calcGeometry(z0, z1) {
    let A = Object.assign(Object.assign({}, points2d.A), { z: z0 });
    let B = Object.assign(Object.assign({}, points2d.B), { z: z0 });
...
function rotatePoint(p, Oz, rotX, rotY) {
    return {
...
function rotateVector(p, rotX, rotY) {
    return {
...
;
function intensityToColorInner(intensity, lower, higher) {
...
function drawGeom(geometry, z0, rotX, rotY) {
    var _a;
    ...
    for (let [str, face, avg, z, intensity] of paths) {
        ...
        if (dynamicColoring) {
            color = intensityToColor(intensity + ((_a = face.intensityDiff) !== null && _a !== void 0 ? _a : 0));
        }
...
function update() {
    var _a, _b, _c, _d, _e;
    dynamicColoring = ((_a = [...document.querySelectorAll('[id^=lighting-]')].find(x => x.checked)) === null || _a === void 0 ? void 0 : _a.getAttribute('value')) === '1';
    let perspective = parseFloat((_c = (_b = [...document.querySelectorAll('[id^=perspective-]')].find(x => x.checked)) === null || _b === void 0 ? void 0 : _b.getAttribute('value')) !== null && _c !== void 0 ? _c : '3');
    let depth = parseFloat((_e = (_d = [...document.querySelectorAll('[id^=depth-]')].find(x => x.checked)) === null || _d === void 0 ? void 0 : _d.getAttribute('value')) !== null && _e !== void 0 ? _e : '0.48');
    z0 = perspective;
